...
from vnpy.service.language.vtConstant import (EMPTY_STRING, EMPTY_UNICODE,
...
########################################################################
class VtTaskData(VtBaseData):
    """订单数据类"""

    #----------------------------------------------------------------------
    def __init__(self):
        """Constructor"""
        super(VtTaskData, self).__init__()

        # 代码编号相关
        self.taskID = EMPTY_STRING              # 任务id
        self.code = EMPTY_STRING            # 交易所代码，使用该代码代表股票代码
        self.name = EMPTY_STRING                # 股票名字

        self.strategyName = EMPTY_STRING            # 合约在vt系统中的唯一代码，通常是 合约代码.交易所代码
        self.riskCtrlName = EMPTY_STRING            # 合约在vt系统中的唯一代码，通常是 合约代码.交易所代码
        self.gatewayName = EMPTY_STRING            # 合约在vt系统中的唯一代码，通常是 合约代码.交易所代码
