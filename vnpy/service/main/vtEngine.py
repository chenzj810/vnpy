...
from vnpy.service.language import text
from vnpy.service.main.vtFunction import getTempPath
from vnpy.service.historyData.historyDataFile.historyDataFile import HistoryDataFile
from vnpy.service.historyData.historyDataDB.historyDataDB import HistoryDataDB
...
class MainEngine(object):
    ...
    def __init__(self, eventEngine):
        ...
        # gateway接口类型管理，字典，key：gatewayName
        ...
        # 标的字典，主引擎挂处理函数，gateway产生数据
        self.eventEngine.register(EVENT_OBJECT_DICT, self.addObjDict)
        # end chenzejun
    ...
    def addGatewayClass(self, gatewayModule):
        ...
        #生成gateway的实例
        appInst = gatewayModule.gatewayClass(self.eventEngine, gatewayName)
    ...
    def newGateway(self, appName):
        ...
        return self.gatewayDict[appName]['gatewayInstance']
    ...
    def getGatewayName(self, displayName):
        ...
        for (k,v) in  self.gatewayDict.items():
