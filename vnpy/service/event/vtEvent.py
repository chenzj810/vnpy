...
from vnpy.service.event.eventType import *
...
EVENT_WEITUO = 'eWeiTuo.'               # 委托单事件
EVENT_TASK = 'eTask.'                   # 运行任务事件
...
# 策略模块相关
EVENT_STRATEGY_LOG = 'eStrategyLog'          # 策略相关的日志事件
EVENT_STRATEGY = 'eStrategy.'        # 策略状态变化事件
...
# STUB模块相关
EVENT_STUB_LOG = 'eStubLog'               # STUB相关的日志事件
EVENT_STUB_STRATEGY = 'eStubStrategy.'    # STUB策略状态变化事件

# OBJICT DICT
EVENT_OBJECT_DICT = 'eObjectDict'      # 标的字典
