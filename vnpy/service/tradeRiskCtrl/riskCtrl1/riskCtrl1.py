...
from vnpy.service.tradeGateway.gateway.vtGateway import VtLogData
from vnpy.service.tradeRiskCtrl.vtRiskManager import RiskCtrlTemplate


########################################################################
class RiskCtrl_1(RiskCtrlTemplate):
    """风控引擎"""
    ...
    def __init__(self, mainEngine, name):
        """Constructor"""
        super(RiskCtrl_1, self).__init__(mainEngine, name)
        self.name = name
